...
public class OtpErlang {
    ...
    public static OtpErlangTuple mkTuple(final Collection<OtpErlangObject> args) {
        return new OtpErlangTuple(
                args.toArray(new OtpErlangObject[args.size()]));
    }
    ...
    public static OtpBindings match(final String pattern,
            final OtpErlangObject term) throws OtpParserException {
    ...
    public static OtpBindings match(final OtpErlangObject pattern,
        ...
        if (pattern.matchTerm(term, bindings)) {
            return bindings;
        }
        return null;
    }
